...
function criaPlaca(placa, pecas, qtdPlaca) {
    ...
    //console.log(placaUtilizada);
    var estrutura = '';
    estrutura += '<div class="col-md-4 placa' + qtdPlaca + '" style="background-color: #ffffea;">';
    ...
    estrutura += '  <div class="ratio' + qtdPlaca + '">Utilizado: <span id="ratio' + qtdPlaca + '">0</span>%</div>';
    ...
    Demo = {
      ...
      init: function () {
        ...
        if (sobrou != '') {
          ...
          $.each(sobrou, function (indexInArray, valueOfElement) {
            ...
            //console.log( pecasSobrou[indexInArray])
          });
      ...
      canvas: {
        ...
        rect: function (x, y, w, h, color) {
         // geracao = (w+h)+(w*h)*12345
          //color = "#"+geracao.toString(16)
